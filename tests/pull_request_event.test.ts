...
describe('pull request event', () => {
  ...
  test('checkout with merge commit', async () => {
    ...
    expect(git.checkout).toHaveBeenCalledExactlyOnceWith('0123456789abcdef-head')
    expect(git.merge).toHaveBeenCalledExactlyOnceWith(
...
https://github.com/int128/update-generated-files-action/actions/runs/4309709120`,
    ...
    expect(git.commit).toHaveBeenCalledExactlyOnceWith(`Generated by GitHub Actions (workflow / job)
