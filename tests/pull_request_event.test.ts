...
https://github.com/int128/update-generated-files-action/actions/runs/4309709120`)
  ...
  test('last authors are this action', async () => {
    jest
      ...
      .mockResolvedValue([git.authorName, git.authorName, git.authorName, git.authorName, git.authorName])
    await expect(handlePullRequestEvent(inputs, context)).rejects.toThrow()
  })
})
