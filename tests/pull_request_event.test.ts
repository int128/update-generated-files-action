...
describe('handlePullRequestEvent', () => {
  ...
  describe('checkout with the merge commit', () => {
    it('cherry-pick the workspace changes onto the head commit', async () => {
      ...
      await handlePullRequestEvent(inputs, githubContext, octokitMock)
  ...
  describe('checkout with the head commit', () => {
