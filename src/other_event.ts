...
export const handleOtherEvent = async (inputs: Inputs, context: PartialContext) => {
  ...
  await git.createBranch({ branch: head, commitMessage: commitMessage(context), token: inputs.token })
...
const commitMessage = (context: PartialContext) => `Generated by GitHub Actions (${context.workflow} / ${context.job})
